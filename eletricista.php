...
if(!isset($_POST['submitEletricistaBtn'])){
?>
    ...
    <section class="contact1" id="contact">
        ...
        <div class="row">
            <form method="POST">
                ...
                <h1 class="heading"> <span>Eletricista</span></h1>
                ...
                <textarea name="motivação" required placeholder="motivação" class="box" id="" cols="30"
                    rows="10"></textarea>
                <input type="submit" value="Enviar Candidatura" name="submitEletricistaBtn" class="btn">
            </form>
...
$sql = "INSERT INTO eletricista (nome, email, telemovel, experiência, motivação) VALUES ('$nome', '$email', '$telemovel', '$experiência', '$motivação')";
