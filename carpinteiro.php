...
if (isset($_POST['submitCarpinteiro'])) {
    ...
    $sql = "INSERT INTO carpinteiro (nome, email, telemovel, experiência, motivação) VALUES ('$nome', '$email', '$telemovel', '$experiência', '$motivação')";
        ...
        <section class="contact1" id="contact">
            ...
            <div class="row">
                <form method="POST">
                    ...
                    <h1 class="heading"> <span>Carpinteiro</span></h1>
                    ...
                    <textarea name="motivação" required placeholder="motivação" class="box" id="" cols="30"
                        rows="10"></textarea>
                    <input type="submit" value="Enviar Candidatura" name="submitCarpinteiro" class="btn">
                </form>
            </div>
