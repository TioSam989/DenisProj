...
<body>
    ...
    <section class="plan2" id="plan">
        ...
        <div class="box-container">
            ...
            $queryEspera = "SELECT COUNT(*) AS count FROM canalizador WHERE status = 'em espera'";
            $queryAceitos = "SELECT COUNT(*) AS count FROM canalizador WHERE status = 'aceito'";
            $queryRejeitados = "SELECT COUNT(*) AS count FROM canalizador WHERE status = 'rejeitado'";
